...
import { useGetOdersIspezione1Query, useGetUserDetailsQuery, useUpdateProfileMutation } from "../../services/apiSlice";
...
const MainLayout14 = ({ areas }) => {
    ...
    // user details
   const {data:userDetails, error, ifFetching, refetch} = useGetUserDetailsQuery({
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            setUserData((prevUser) => ({ ...prevUser, profileImage: blobUrl, profileImageFile: file }));
        }
    };
                    ...
                    {findAreaByKeyPrefix('EditArea4') || <div>- -</div>}
                        <div className="form-input-block">
                            ...
                            <div className="row row-gap">
                                        {findAreaByKeyPrefix('FormArea17', {userData, handleImageChange}) || <div>- -</div>}
                                        {findAreaByKeyPrefix('FormArea13', {userData, handleChange}) || <div>- -</div>}
                                        {findAreaByKeyPrefix('FormArea18', {userData, handleChange}) || <div>- -</div>}
                                        {findAreaByKeyPrefix('FormArea10', {userData, handleChange}) || <div>- -</div>}
                                        {findAreaByKeyPrefix('FormArea12', {userData, handleChange}) || <div>- -</div>}
                                        </div>
