              ...
              <div className="cards-block Ispezioni-block card-block-body">
                <div className="card-header border-0 add-form-header pb-0">
                  <div className="card-title">
                    {findAreaByKeyPrefix("IspezioniFormArea1", areas) || (
                      <div>- -</div>
                    )}
                    {findAreaByKeyPrefix("IspezioniTableNameArea1", areas) || (
                      <div>- -</div>
                    )}
                  </div>
                  {findAreaByKeyPrefix("IspezioniSearchArea1", areas, {
                    searchText: searchText1,
                    setSearchText: setSearchText1,
                  }) || <div>- -</div>}
                </div>
                <div className="pt-1">
                  {findAreaByKeyPrefix("IspezioniArea1", areas, {
                    TableData1,
                  }) || <div>- -</div>}
                  {totalDocuments1 > perPageItem1 &&
                    (findAreaByKeyPrefix("PaginationArea1", areas, {
                      totalDocuments: totalDocuments1,
                      currentPage: currentPage1,
                      perPageItem: perPageItem1,
                      handlePageClick,
                    }) || <div>- -</div>)}
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="cards-block Ispezioni-block card-block-body">
                <div className="card-header border-0 add-form-header pb-0">
                  <div className="card-title">
                    {findAreaByKeyPrefix("IspezioniFormArea2", areas) || (
                      <div>- -</div>
                    )}
                    {findAreaByKeyPrefix("IspezioniTableNameArea2", areas) || (
                      <div>- -</div>
                    )}
                  </div>
                  {findAreaByKeyPrefix("IspezioniSearchArea2", areas, {
                    searchText: searchText2,
                    setSearchText: setSearchText2,
                  }) || <div>- -</div>}
                </div>
                <div className="pt-1">
                  {findAreaByKeyPrefix("IspezioniArea2", areas, {
                    TableData2,
                    handleModal,
                    modalRef,
                    deleteInspection,
                  ...
                  {totalDocuments2 > perPageItem2 &&
                    (findAreaByKeyPrefix("PaginationArea1", areas, {
                      totalDocuments: totalDocuments2,
                      currentPage: currentPage2,
                      perPageItem: perPageItem2,
                      handlePageClick2,
                    }) || <div>- -</div>)}
                </div>
              </div>
