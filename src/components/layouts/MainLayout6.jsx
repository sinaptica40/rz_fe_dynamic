            ...
            <div className="side_nav">
                <div className="side_nav_inner">
                    <ul className="sideNav_menu">
                        {findAreaByKeyPrefix('ReportArea1') || <div>- -</div>}
                        {findAreaByKeyPrefix('ReportArea2') || <div>- -</div>}
                        {findAreaByKeyPrefix('ReportArea3') || <div>- -</div>}
                        {findAreaByKeyPrefix('ReportArea4') || <div>- -</div>}
                        {findAreaByKeyPrefix('ReportArea5') || <div>- -</div>}
