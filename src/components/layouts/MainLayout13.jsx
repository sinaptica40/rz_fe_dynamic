...
const subIndex = sessionStorage.getItem('subIndex')
    useEffect(() => {
    ...
    <div className={`app ${isPageOpen ? "is-folded" : ""}`}>
      ...
      <div className="side_nav">
        ...
        <div className="side_nav_inner">
          ...
          {findAreaByKeyPrefix("ReportNavBarArea2", { inspectionData, getApi, setPage})}
        </div>
      </div>

      <div className="webcontent-wrapper side_mar">
        {findAreaByKeyPrefix("ReportEditArea", {getApi})}
      </div>
      </div>
    </>
  );
