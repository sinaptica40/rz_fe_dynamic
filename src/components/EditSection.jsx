...
const EditSection = ({ data, handleEdit, handleImage, index = null }) => {
    ...
    const [texts, setTexts] = useState(data?.polygon_text || []);
        ...
        <div className="col-lg-12  mb-4">
          ...
          <div className="records_photography_box space-0">
            <div className="records_photography_box records_photography_row space-0 ">
              ...
              <div className="right_photoItem" style={{ color: isWriteMode ? "orange" : ""}}>
                    ...
                    onClick={() => {
                      ...
                      canvas.toBlob((blob) => {
                        if (blob) {
                          ...
                          setCapturedFile1(file);
                          handleEdit(index, data?.inspectionnotes, data?.id_not_conformity_detail, data?.original_image, shapes, file, original_image[index], audioFile, newTextData, texts)
                        } 
                      });
                    }}
